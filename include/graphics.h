...
void DrawArrow(SDL_Surface * screen, SDL_Rect pos, struct Point f,
               float factor, Uint32 color, int type);
void DrawScale(SDL_Surface * screen, Uint32 * color, Uint32 border,
...
void GenMiniColorTable(SDL_Surface * screen, Uint32 * ct, int n,
