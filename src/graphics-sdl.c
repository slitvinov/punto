...
void
DrawLine(SDL_Surface * surface, int x0, int y0, int x1, int y1,
         Uint32 color)
{
    /*
...
void
DrawLine32(SDL_Surface * surf, int x0, int y0, int x1, int y1,
           Uint32 color)
{
    /*
       Draw a line that starts at x0,y0 and ends at x1,y1
...
void
PutPixelCircle(SDL_Surface * screen, int x, int y, int x0, int y0,
...
void
DrawCircle(SDL_Surface * screen, int x0, int y0, int r, Uint32 color)
{
    /*
       Draw a circle
     */
...
void
FillRing(SDL_Surface * surface, int x0, int y0, int r, int h, Uint32 color)
{
    /*
...
void
FillCircle(SDL_Surface * surface, int x0, int y0, int r, Uint32 color)
{
    /*
...
SDL_Surface *
CreateBall(SDL_Surface * screen, Uint32 color, Uint32 bcolor, int radio)
{
    /* 
    ...
    temp =
        SDL_CreateRGBSurface(SDL_HWSURFACE, 2 * radio + 1, 2 * radio + 1,
                             (int) screen->format->BitsPerPixel, 0, 0, 0,
                             0);
...
SDL_Surface *
CreateBall3D(SDL_Surface * screen, Uint32 color, int radio)
{
    /* 
    ...
    if (radio < 2) {
        ...
        for (i = (float) radio; i > 0; i -= inci) {
            ...
            b = blue - ib * i;
            color = SDL_MapRGB(screen->format, r, g, b);
            FillRing(temp, radio, radio, (int) (i),
                     (int) (inci * 1.4142 + .5) + 1, color);
        }
    }
...
void
FillRectangle(SDL_Surface * surface, int x0, int y0, int x1, int y1,
              Uint32 color)
{
    /*
...
SDL_Surface *
CreateRectangle(SDL_Surface * screen, Uint32 color, Uint32 bcolor,
                int radio)
{
/* 
...
*/
    ...
    temp =
        SDL_CreateRGBSurface(SDL_SWSURFACE, radio, radio,
                             (int) screen->format->BitsPerPixel, 0, 0, 0,
                             0);
...
int
DrawText(SDL_Surface * screen, char *text, int x0, int y0, Uint32 color)
{
    /*
...
int
DrawChar(SDL_Surface * screen, char **text, int x, int y, Uint32 color)
{
    int i, j, k, l;
