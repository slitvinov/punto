...
void DrawCircleold(SDL_Surface * surface, int x0, int y0, int r,
                   Uint32 color);
void FillCircle(SDL_Surface * surface, int x0, int y0, int r,
                Uint32 color);
void FillCircleold(SDL_Surface * surface, int x0, int y0, int r,
                   Uint32 color);
...
void FillRectangle(SDL_Surface * surface, int x0, int y0, int x1, int y1,
                   Uint32 color);
SDL_Surface *CreateRectangle(SDL_Surface * screen, Uint32 color,
                             Uint32 bcolor, int radio);
