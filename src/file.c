...
int
FindChain(char *target, char *cad[], int n)
{
...
int
ReadNBlocks(char *fname, struct Block *br, long fpos)
{
    /* 
       version 0.1
...
int
TakeWordFromCad(char *word, char *cad)
{
...
size_t
ReadWordFromCad(char *word, char *cad)
{
